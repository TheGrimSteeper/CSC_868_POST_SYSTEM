...
public class TransactionLog {
    ...
    private void pushTransactiontoDB(Transaction transaction) {
        ...
        try {
            URL urlTransactions = new URL("http://localhost:8080/WebApplication1/webresources/com.store2entity.transactions");
    ...
    private void pushSalesLineItemstoDB(Transaction transaction) {
        ...
        try {
            URL urlTransactionLines = new URL("http://localhost:8080/WebApplication1/webresources/com.store2entity.transactionlines");
